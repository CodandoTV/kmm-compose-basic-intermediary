...
val samplePosts = listOf(
    Post(
        id = "1",
        description = "Mais vale um pássaro na mão do que dois voando.",
        likes = 10,
        comments = 2,
    ...
    Post(
        id = "2",
        description = "Água mole em pedra dura...",
        likes = 20,
        comments = 4,
    ...
    Post(
        id = "3",
        description = "A pressa é inimiga da perfeição.",
        likes = 30,
        comments = 6,
    ...
    Post(
        id = "4",
        description = "De grão em grão, a galinha enche o papo.",
        likes = 40,
        comments = 8,
    ...
    Post(
        id = "5",
        description = "Quem não arrisca, não petisca.",
        likes = 50,
        comments = 10,
